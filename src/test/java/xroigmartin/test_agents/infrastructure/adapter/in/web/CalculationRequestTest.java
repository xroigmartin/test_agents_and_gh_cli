...
class CalculationRequestTest {
  ...
  void should_trim_operation_when_value_contains_extra_spaces() {
    ...
    CalculationRequest request =
        new CalculationRequest(rawOperation, BigDecimal.ONE, BigDecimal.ZERO);
  ...
  void should_throw_exception_when_operation_is_blank() {
    ...
    assertThrows(
        ...
        () -> new CalculationRequest(rawOperation, BigDecimal.ONE, BigDecimal.ONE));
  }
  ...
  void should_throw_exception_when_first_operand_is_null() {
    ...
    // When / Then
    assertThrows(
        NullPointerException.class, () -> new CalculationRequest("ADDITION", null, BigDecimal.ONE));
  }
  ...
  void should_throw_exception_when_second_operand_is_null() {
    ...
    // When / Then
    assertThrows(
        NullPointerException.class, () -> new CalculationRequest("ADDITION", BigDecimal.ONE, null));
  }
}
