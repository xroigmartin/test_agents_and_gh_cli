...
class DefaultCalculateOperationUseCaseTest {
  ...
  private final CalculateOperationUseCase useCase =
      new DefaultCalculateOperationUseCase(calculator);

  @Test
  void should_return_sum_when_operation_is_addition() {
    // Given
    CalculateOperationCommand command =
        new CalculateOperationCommand(Operation.ADDITION, new BigDecimal("5"), new BigDecimal("3"));
  ...
  void should_return_difference_when_operation_is_subtraction() {
    // Given
    CalculateOperationCommand command =
        new CalculateOperationCommand(
            Operation.SUBTRACTION, new BigDecimal("9"), new BigDecimal("4"));
  ...
  void should_return_product_when_operation_is_multiplication() {
    ...
    CalculateOperationCommand command =
        new CalculateOperationCommand(
            Operation.MULTIPLICATION, new BigDecimal("7"), new BigDecimal("6"));
  ...
  void should_return_quotient_when_operation_is_division() {
    ...
    CalculateOperationCommand command =
        new CalculateOperationCommand(
            Operation.DIVISION, new BigDecimal("18"), new BigDecimal("3"));
  ...
  void should_round_division_result_using_decimal128_precision() {
    // Given
    CalculateOperationCommand command =
        new CalculateOperationCommand(Operation.DIVISION, new BigDecimal("1"), new BigDecimal("3"));
  ...
  void should_return_power_when_operation_is_power() {
    // Given
    CalculateOperationCommand command =
        new CalculateOperationCommand(Operation.POWER, new BigDecimal("2"), new BigDecimal("3"));
  ...
  void should_handle_negative_exponent_when_operation_is_power() {
    // Given
    CalculateOperationCommand command =
        new CalculateOperationCommand(Operation.POWER, new BigDecimal("4"), new BigDecimal("-2"));
  ...
  void should_return_percentage_when_operation_is_percentage() {
    ...
    CalculateOperationCommand command =
        new CalculateOperationCommand(
            Operation.PERCENTAGE, new BigDecimal("200"), new BigDecimal("15"));
  ...
  void should_throw_division_by_zero_when_divisor_is_zero() {
    // Given
    CalculateOperationCommand command =
        new CalculateOperationCommand(Operation.DIVISION, new BigDecimal("5"), BigDecimal.ZERO);
