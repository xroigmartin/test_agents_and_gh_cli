...
/**
 * Default implementation of {@link Calculator} that relies on {@link MathContext#DECIMAL128} to
 * perform deterministic decimal arithmetic.
 */
public final class BasicCalculator implements Calculator {
  ...
  public BigDecimal add(BigDecimal augend, BigDecimal addend) {
    return requireNonNull(augend, "augend")
        .add(requireNonNull(addend, "addend"), DEFAULT_MATH_CONTEXT);
  }

  @Override
  public BigDecimal subtract(BigDecimal minuend, BigDecimal subtrahend) {
    return requireNonNull(minuend, "minuend")
        .subtract(requireNonNull(subtrahend, "subtrahend"), DEFAULT_MATH_CONTEXT);
  }

  @Override
  public BigDecimal multiply(BigDecimal multiplicand, BigDecimal multiplier) {
    return requireNonNull(multiplicand, "multiplicand")
        .multiply(requireNonNull(multiplier, "multiplier"), DEFAULT_MATH_CONTEXT);
  }
  ...
  public BigDecimal percentage(BigDecimal base, BigDecimal percent) {
    ...
    return safeBase
        .multiply(safePercent, DEFAULT_MATH_CONTEXT)
